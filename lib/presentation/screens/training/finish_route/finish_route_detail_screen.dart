// lib/presentation/screens/training/finish_route/finish_route_detail_screen.dart
...
class FinishRouteDetailScreen extends StatelessWidget {
  final String recordId;
  final Map<String, dynamic> data;

  const FinishRouteDetailScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CommonAppBar(title: '피니쉬 루트 상세 기록'),
                          ...
                          return ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '최적 루트: ${primary.join(" → ")} (${primary.length}다트)',
                                  style: const TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.green,
