                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Flexible(
                                    child: Text(koreanName, style: theme.textTheme.titleLarge),
                                  ),
                                  if (shopName.isNotEmpty) ...[
                                    const SizedBox(width: 8),
                                    Text('· $shopName', style: theme.textTheme.bodyLarge?.copyWith(color: theme.colorScheme.primary)),
                                  ],
                                ],
                              ),
                          ...
                          child: Column(
                            ...
                            children: [
                              if (barrelName.isNotEmpty)
                                Text(barrelName, style: theme.textTheme.bodyMedium),
                            ],
                          ),
                        ),
                      ],
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (comments.isEmpty) {
                  return const Center(child: Text('아직 댓글이 없어요'));
                }
