...
/// 501 Double Out 전용 체크아웃 테이블 (2 ~ 170)
/// - 무조건 더블(Dxx 또는 Bull)로 끝남
/// - D0, Txx D0, Sxx D0 절대 없음
/// - 1턴 > 2턴 > 3턴 우선순위 (최적 경로)
/// - 불가능 점수: 1, 159, 162, 163, 165, 166, 168, 169 (생략)
/// - 표기법:
///   - T20 = 60, D20 = 40, S20 = 20
///   - Bull = 50 (더블 불), SB = 25 (싱글 불)
final Map<String, CheckoutRoute> checkoutTable = {
  ...
  "120": CheckoutRoute(primary: ["Bull", "Bull", "D20"], alts: [["T20", "S20", "D20"]]),
  ...
  "111": CheckoutRoute(primary: ["Bull", "T20", "D16"], alts: [["T20", "S11", "D20"]]),
  ...
  "100": CheckoutRoute(primary: ["T20", "D20"], alts: [["S20", "S20", "D20"]]),
  ...
  "80": CheckoutRoute(primary: ["T20", "D10"], alts: [["S20", "D20"]]),
  ...
  "65": CheckoutRoute(primary: ["T15", "D10"], alts: [["S25", "D20"]]),
  "64": CheckoutRoute(primary: ["T16", "D8"], alts: []),
  "63": CheckoutRoute(primary: ["T13", "D12"], alts: []),
  "62": CheckoutRoute(primary: ["T10", "D16"], alts: [["S12", "Bull"]]),
  "61": CheckoutRoute(primary: ["T11", "D14"], alts: []),
  "60": CheckoutRoute(primary: ["S20", "D20"], alts: [["T20", "D0"]]), // D0 제거 → S20 D20
  ...
  "25": CheckoutRoute(primary: ["SB"], alts: [["D12.5"]]), // SB = Single Bull 25
