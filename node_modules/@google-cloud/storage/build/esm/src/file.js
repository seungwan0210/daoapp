...
(function (FileExceptionMessages) {
    ...
    FileExceptionMessages["ABSOLUTE_FILE_NAME"] = "Object name is an absolute path. Security block to prevent arbitrary file writes.";
    FileExceptionMessages["TRAVERSAL_OUTSIDE_BASE"] = "Path traversal detected. Security block to prevent writing outside the base directory.";
    FileExceptionMessages["TRAVERSAL_OUTSIDE_BASE_DESTINATION"] = "The provided destination path is unsafe and attempts to traverse outside the application's base directory (current working directory).";
