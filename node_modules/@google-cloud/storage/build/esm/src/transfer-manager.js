...
export class TransferManager {
    ...
    async downloadManyFiles(filesOrFolder, options = {}) {
        ...
        for (const file of files) {
            ...
            if (path.isAbsolute(name)) {
                const absolutePathError = new RequestError(FileExceptionMessages.ABSOLUTE_FILE_NAME);
            ...
            if (finalPath !== baseDir && !finalPath.startsWith(normalizedBaseDir)) {
                const traversalError = new RequestError(FileExceptionMessages.TRAVERSAL_OUTSIDE_BASE);
    ...
    _resolveAndValidateBaseDir(options) {
        ...
        if (relativeBaseDir.startsWith('..') || path.isAbsolute(relativeBaseDir)) {
            const traversalError = new RequestError(FileExceptionMessages.TRAVERSAL_OUTSIDE_BASE_DESTINATION);
            throw traversalError;
        }
        return baseDir;
    }
