...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // DropdownButton의 value가 supportedLocales에 포함되는지 확인하고, 없으면 기본값 설정
    String dropdownValue = currentLocale.toString();
    final supportedLocaleStrings = AppLocalizations.supportedLocales.map((l) => l.toString()).toList();
    if (!supportedLocaleStrings.contains(dropdownValue)) {
      dropdownValue = supportedLocaleStrings.first; // 기본값으로 첫 번째 로케일 사용
      _logger.w("Current locale $currentLocale not in supported locales, defaulting to $dropdownValue");
    }
                  ...
                  children: [
                    ...
                    DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        value: dropdownValue, // 유효한 값으로 설정
